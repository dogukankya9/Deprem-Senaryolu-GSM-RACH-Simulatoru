...
class RachSimulationApp:
    ...
    def generate_traffic(self, manual_boost=0):
        ...
        if len(non_barred) <= available_slots:
            ...
            # RACH çakışma olasılığı şebeke yüküne göre dinamik hesaplanır.
            # Eski sistemde overflow kullanıcıların %80'i çakışıyordu.
            # Bu yüzden düşük yükte bile gereksiz fazla RACH çakışması oluşuyordu.
            if self.network_load < 40:
        ...
        # Bellek taşmasını önlemek için geçmiş veriyi 200 turla sınırla
        MAX_HISTORY = 200
